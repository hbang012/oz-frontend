...
export default function MainBlogTablet() {
  ...
  return (
    <div className="max-w-[1200px] mx-auto">
      {/* 제목 */}
      <div className="flex relative justify-between items-center gap-[4px]">
        <h2 className="text-[#000] font-bold text-[24px]">Focus On</h2>
        {/* 버튼 */}
