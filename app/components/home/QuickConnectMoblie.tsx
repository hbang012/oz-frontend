...
export default function QuickConnectMoblie() {
  return (
    <div className="max-w-[1200px] mx-auto" style={{ paddingTop: '30px' }}>
      ...
      <div className="flex flex-col items-center gap-4 mt-[40px] ">
        ...
        <button
          type="button"
          className="group relative overflow-hidden flex w-[200px] h-[58px] p-[15px] justify-center items-center gap-[4px] text-[#fff] font-bold text-[14px] bg-[#000] rounded-[100px] transition-colors duration-500 [transition-timing-function:cubic-bezier(0.5,0,0.1,1)]"
        ...
        <button
          type="button"
          className="group relative overflow-hidden flex p-[15px] justify-center items-center gap-[4px] text-[#000] font-bold text-[14px] border border-[#eee] rounded-[100px] shadow-[inset_0px_0px_0px_1px_rgb(238,238,238)] transition-colors duration-500 [transition-timing-function:cubic-bezier(0.5,0,0.1,1)]"
          style={{ width: '165px', height: '48px' }}
        >
          <Link
            href={'/'}
