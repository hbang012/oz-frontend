...
export default function ProdutOptionsTablet({ productId }: ProdutOptionsProps) {
  // 옵션
  ...
  return (
    <div>
        ...
        >
          <div className="flex flex-col">
            ...
            <p
              ...
              style={{ width: '20%', color: '#777', marginBottom: '5px' }}
            >
              {group.name}
            </p>
            <button
              ...
              onClick={() =>
                setOpenGroup(
                  openGroup === group.group_id ? null : group.group_id
                )
              }
            >
              <div className="">
      ...
      <div
        ...
        style={{ borderColor: '#999', paddingTop: '30px' }}
      >
        <div
          className="relative flex flex-col border-t-1"
          style={{ gap: '0px', margin: '30px 0px' }}
        >
          <p
            className="font-bold"
            style={{ width: '20%', color: '#777', padding: '30px 0px 0px 0px' }}
          >
            배송방법
          </p>
        ...
        {selectedDeliveryOption === '택배' && (
          <div className=" text-[#999] text-[12px] flex justify-start ">
            무료 배송
            <span className="ml-4" style={{ marginBottom: '20px' }}>
              제주·도서산간 추가 5,000원
            </span>
          </div>
        )}
