  ...
  return (
    <div className="flex flex-col gap-[35px] justify-center items-center mb-[90px]">
      ...
      <div>
        ...
        <div className="max-w-[340px] h-[327px] bg-[#f6f6f6] rounded-[8px] p-[30px]">
          <ul className="grid grid-cols-2 gap-[10px]">
            {steps.map(({ src, text }, idx) => (
              ...
              >
                <img src={src} alt="" />
                <p className="text-[11px] text-[#000] text-center mt-[8px]">
                  {text}
                </p>
              </li>
            ))}
      ...
      <div>
        ...
        <div className="max-w-[320px] flex justify-center items-center gap-[10px] h-[159px] bg-[#f5f4ff] rounded-[8px] p-[30px]">
          <ul className="flex gap-[10px]">
            {steps2.map(({ src, text }, idx) => (
              <React.Fragment key={idx}>
                <li className="w-[60px] flex flex-col justify-center items-center">
                  <img src={src} alt="" />
                  <p className="text-[11px] text-[#000] text-center mt-[8px]">
                    {text}
                  </p>
