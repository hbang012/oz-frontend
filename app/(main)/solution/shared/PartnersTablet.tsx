...
export default function PartnersTablet() {
  return (
    <div className="mb-[90px]">
      ...
      <Swiper
        spaceBetween={20}
        slidesPerView={3}
        className={`${styles.swiperWrapper} relative`}
        loop={true}
        autoplay={{
          delay: 0,
        ...
        <ul className="">
          {Reviews.map((item) => (
            <SwiperSlide key={item.id}>
              <li
                className={` flex flex-col gap-[14px] rounded-[8px] border-[#eee] border h-[280px] bg-[#f8f8f8]`}
              >
                <div className="flex justify-between items-center p-[15px_20px] bg-white rounded-[8px]">
                  <h2 className="w-[254px] text-[16px] font-bold text-[#000]">
                    {item.name}
                  </h2>
                ...
                <div className="p-[20px_30px_0px]">
                  <p className="text-[14px] line-clamp-7 text-[#000]">
                    {item.reviews}
                  </p>
                </div>
              </li>
      ...
      {/* 파트너 */}
      <div className="flex justify-center items-center p-[40px_10px_0px]">
        <img
          src={'/images/solution/mobile.png'}
          alt=""
          className=" w-[652px] h-[896px] mb-[40px]"
        />
      </div>
      ...
      <div className="flex justify-center items-center gap-[20px]">
        <button
          type="button"
          className="rounded-[8px] bg-white border-point1 border w-[99px] h-[45px] text-point1 text-[12px] flex justify-center items-center font-bold"
        >
          제작사례 더보기
        </button>
        <button
          type="button"
          className="rounded-[8px] bg-point1 w-[99px] h-[45px] text-white text-[12px] flex justify-center items-center font-bold"
        >
          문의하기
        </button>
      </div>
