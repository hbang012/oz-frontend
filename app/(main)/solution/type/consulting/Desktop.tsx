  ...
  return (
    <>
      ...
      <header className="relative top-[85px] w-full overflow-hidden">
        <img
          src={'/images/solution/consulting01.png'}
          alt=""
        ...
        <div className="absolute top-[55px] right-[50%]">
          ...
          <p>어떤 굿즈를 만들면 좋을지 고민하지 않아도 돼요!</p>
        </div>
      </header>
        ...
        <div className="flex justify-center pt-[66px]">
          <div className="relative w-[950px] border rounded-[15px] border-[#d8d8d8] p-[28px_41px_28px_32px]">
            <img
              ...
              alt=""
              className="absolute top-[-21px] right-[37px] w-[103px] h-[67px]"
            />
            <h3 className="text-[20px] font-bold text-[#000]">
              이런 분에게 추천해요
            </h3>
            <ul className="flex gap-[55px] pt-[25px]">
