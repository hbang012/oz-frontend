  ...
  return (
    <MainLayout>
      <main className="max-w-[1200px] mx-auto" style={{ padding: '50px 20px' }}>
        {/* 제목 */}
        <div className="">
          <h1 className="text-[15px] p-[50px_0px_35px] font-bold leading-[36px]">
          ...
          {loading ? (
            ...
            blogs.length > 0 ? (
              ...
              <ul
                ...
                style={{ gap: '30px 16px', paddingTop: '50px' }}
              >
                {blogs.map((post) => (
                  <li
                    key={post.post_id}
                  ...
                  >
                    ...
                    />
                    <h3 className="p-[16px] text-[15px] text-[#000] font-bold">
                      {post.title}
                    </h3>
                  </li>
                ))}
            ...
            <ul
              ...
              style={{ paddingTop: '60px', gap: '15px' }}
            >
              {products.map((item) => (
