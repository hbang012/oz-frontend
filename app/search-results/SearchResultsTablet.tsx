...
export default function SearchResultsTablet() {
              ...
              >
                {blogs.map((post) => (
                  ...
                  >
                    ...
                    />
                    <h3 className="truncate w-[145px] p-[16px] text-[18px] text-[#000] font-bold">
                      {post.title}
                    </h3>
                  </li>
                ))}
            ...
            >
              {products.map((item) => (
                <li key={item.product_id} className="relative">
                  ...
                  <h3 className="truncate w-[113px] font-bold text-[14px]">
                    {item.name}
                  </h3>
